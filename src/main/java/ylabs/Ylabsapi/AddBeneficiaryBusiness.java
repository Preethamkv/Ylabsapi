...
public class AddBeneficiaryBusiness {
							    ...
							    public static void test(){
							        ...
							        String url="https://ylabsapi.yantracard.com/api/customer/"+customer_id+"/beneficiary";
							        ...
							        try {
							            ...
							            json.put("email", "james.smith@gmail.com");
							            json.put("addressLine1","1430 Lakeside View");
							            json.put("mobileNumber","7784356790");
							            json.put("state", "KS");
							            json.put("zipCode","66044");
							            json.put("dob", "1996-01-01");
							            json.put("nickname", "JS");
							            json.put("country", "US");
							            json.put("businessName" ,"Finatel");
							            json.put("tin","123456789");
							            json.put("type","business");
