...
public class Masspay {
									    ...
									    public static void test(){
									      ...
									      // int funding_source_id=601;
									        String url="https://ylabsapi.yantracard.com/api/transfer/masspay";
									        ...
									        try {
									            ...
									            json.put("fromAccountId","375");
									            json.put("reference","REF123dfed006");
									            json.put("transactions","[");
									            json.put("instrumentId","17367041");
									            json.put("amount","1.1");
									            json.put("notes", "test");
									            json.put("instrumentId","1736705");
									            json.put( "amount","1.2");
									            json.put("notes","test");
									            json.put( "instrumentId","1736706");
									            json.put("amount","1.3");
									            json.put( "notes","test");
									            json.put( "transactions","]");
