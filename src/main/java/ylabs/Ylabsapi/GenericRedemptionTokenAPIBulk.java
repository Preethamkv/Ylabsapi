...
public class GenericRedemptionTokenAPIBulk {
	;
									    ...
									    public static void test(){
									      ...
									      // int funding_source_id=601;
									        String url="https://ylabsapi.yantracard.com/api/moneyrequest/bulk";
									        ...
									        try {
									            ...
									            json.put("accountId","1104");
									            json.put("emailId","james@email.com");
									            json.put("amount","10");
									            json.put("referenceNumber", "redem0015");
									            json.put("notes","redemToken");
									            json.put("purposeCode", "P102");
